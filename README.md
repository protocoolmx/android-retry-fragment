# Retry-Fragment
[![Download](https://img.shields.io/badge/bintray-0.5.0-brightgreen.svg)](https://bintray.com/protocool/maven/android-retry-fragment/0.5.0)
...
```groovy
compile 'cool.proto:retry-fragment:0.5.0'
```
